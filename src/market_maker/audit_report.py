"""Shared audit report utilities — promoted from scripts/tools/audit_report_common.py."""
...
from market_maker.audit_common import parse_env, read_env_lines, safe_decimal
